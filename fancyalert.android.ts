...
export class TNSFancyAlert {
    ...
    public static showSuccess(title: string, subTitle?: string, closeBtnTitle?: string) {
        let alert = new PromptDialog(app.android.currentContext);
    ...
    public static showError(title: string, subTitle?: string, closeBtnTitle?: string) {
        let alert = new PromptDialog(app.android.currentContext);
    ...
    public static showNotice(title: string, subTitle?: string, closeBtnTitle?: string) {
        let alert = new PromptDialog(app.android.currentContext);
    ...
    public static showWarning(title: string, subTitle?: string, closeBtnTitle?: string) {
        let alert = new PromptDialog(app.android.currentContext);
    ...
    public static showInfo(title: string, subTitle?: string, closeBtnTitle?: string) {
        let alert = new PromptDialog(app.android.currentContext);
